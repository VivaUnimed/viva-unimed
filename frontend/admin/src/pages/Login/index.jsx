      ...
      <div className="login-content">
        <div className="welcome-login-section">
          <div className="welcome-login-section-content">
            <div className='logo-login-container'><Logo/></div>
        ...
        <div className="login-section-form">
          ...
          <div className='form-inputs-login'>
            <Input label={'E-mail Corporativo'} styles={{minWidth: '150px'}}/>
            <Input label={'Senha'} styles={{width: '80%', minWidth: '150px'}}/>
          </div>
          <a className='reset-password' href="">Esqueci a minha senha</a>
        </div>
      </div>
    </div>
  );
